import time, os, tqdm, torch, argparse, glob, subprocess, warnings, cv2, pickle, numpy, pdb, math, python_speech_features
import sys
...
def inference_video(args):
	...
	for fidx, fname in enumerate(flist):
		...
		sys.stderr.write('%s-%05d; %d dets\r' % (args.videoFilePath, fidx, len(dets[-1]))) # noqa
